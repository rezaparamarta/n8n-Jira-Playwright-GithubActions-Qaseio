...
export declare const PlansApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getPlans: (code: string, limit?: number, offset?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const PlansApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createPlan(code: string, planCreate: PlanCreate, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IdResponse>>;
    /**
     * This method completely deletes a plan from repository.
     * @summary Delete plan
     * @param {string} code Code of project, where to search entities.
     ...
     * @throws {RequiredError}
     */
    deletePlan(code: string, id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IdResponse>>;
    /**
     * This method allows to retrieve a specific plan.
     * @summary Get a specific plan
     * @param {string} code Code of project, where to search entities.
     ...
     * @throws {RequiredError}
     */
    getPlan(code: string, id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PlanResponse>>;
    /**
     * This method allows to retrieve all plans stored in selected project.
     * @summary Get all plans
     * @param {string} code Code of project, where to search entities.
     ...
     * @throws {RequiredError}
     */
    getPlans(code: string, limit?: number, offset?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PlanListResponse>>;
    /**
     * This method updates a plan.
     * @summary Update plan
     * @param {string} code Code of project, where to search entities.
     ...
     * @throws {RequiredError}
     */
    updatePlan(code: string, id: number, planUpdate: PlanUpdate, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IdResponse>>;
};
/**
