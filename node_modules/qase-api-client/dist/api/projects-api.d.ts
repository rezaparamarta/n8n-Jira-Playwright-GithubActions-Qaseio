...
export declare const ProjectsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getProjects: (limit?: number, offset?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const ProjectsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createProject(projectCreate: ProjectCreate, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectCodeResponse>>;
    /**
     * This method allows to delete a specific project.
     * @summary Delete Project by code
     * @param {string} code Code of project, where to search entities.
     ...
     * @throws {RequiredError}
     */
    deleteProject(code: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BaseResponse>>;
    /**
     * This method allows to retrieve a specific project.
     * @summary Get Project by code
     * @param {string} code Code of project, where to search entities.
     ...
     * @throws {RequiredError}
     */
    getProject(code: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectResponse>>;
    /**
     * This method allows to retrieve all projects available for your account. You can limit and offset params to paginate.
     * @summary Get All Projects
     * @param {number} [limit] A number of entities in result set.
     ...
     * @throws {RequiredError}
     */
    getProjects(limit?: number, offset?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProjectListResponse>>;
    /**
     * This method allows to grant access to a specific project.
     * @summary Grant access to project by code
     * @param {string} code Code of project, where to search entities.
     ...
     * @throws {RequiredError}
     */
    grantAccessToProject(code: string, projectAccess: ProjectAccess, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BaseResponse>>;
    /**
     * This method allows to revoke access to a specific project.
     * @summary Revoke access to project by code
     * @param {string} code Code of project, where to search entities.
     ...
     * @throws {RequiredError}
     */
    revokeAccessToProject(code: string, projectAccess: ProjectAccess, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BaseResponse>>;
};
/**
...
export declare class ProjectsApi extends BaseAPI {
     ...
     * @memberof ProjectsApi
     */
    deleteProject(code: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<BaseResponse, any, {}>>;
    /**
     * This method allows to retrieve a specific project.
     * @summary Get Project by code
     * @param {string} code Code of project, where to search entities.
     ...
     * @memberof ProjectsApi
     */
    grantAccessToProject(code: string, projectAccess: ProjectAccess, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<BaseResponse, any, {}>>;
    /**
     * This method allows to revoke access to a specific project.
     * @summary Revoke access to project by code
     * @param {string} code Code of project, where to search entities.
     ...
     * @memberof ProjectsApi
     */
    revokeAccessToProject(code: string, projectAccess: ProjectAccess, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<BaseResponse, any, {}>>;
}
