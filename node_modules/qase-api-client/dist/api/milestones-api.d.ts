...
export declare const MilestonesApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getMilestones: (code: string, search?: string, limit?: number, offset?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const MilestonesApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    createMilestone(code: string, milestoneCreate: MilestoneCreate, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IdResponse>>;
    /**
     * This method completely deletes a milestone from repository.
     * @summary Delete milestone
     * @param {string} code Code of project, where to search entities.
     ...
     * @throws {RequiredError}
     */
    deleteMilestone(code: string, id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IdResponse>>;
    /**
     * This method allows to retrieve a specific milestone.
     * @summary Get a specific milestone
     * @param {string} code Code of project, where to search entities.
     ...
     * @throws {RequiredError}
     */
    getMilestone(code: string, id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MilestoneResponse>>;
    /**
     * This method allows to retrieve all milestones stored in selected project.
     * @summary Get all milestones
     * @param {string} code Code of project, where to search entities.
     ...
     * @throws {RequiredError}
     */
    getMilestones(code: string, search?: string, limit?: number, offset?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MilestoneListResponse>>;
    /**
     * This method updates a milestone.
     * @summary Update milestone
     * @param {string} code Code of project, where to search entities.
     ...
     * @throws {RequiredError}
     */
    updateMilestone(code: string, id: number, milestoneUpdate: MilestoneUpdate, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IdResponse>>;
};
/**
...
export declare class MilestonesApi extends BaseAPI {
     ...
     * @memberof MilestonesApi
     */
    getMilestones(code: string, search?: string, limit?: number, offset?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<MilestoneListResponse, any, {}>>;
    /**
     * This method updates a milestone.
     * @summary Update milestone
     * @param {string} code Code of project, where to search entities.
