 ...
 * @export
 */
export declare const SuitesApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     * @throws {RequiredError}
     */
    deleteSuite: (code: string, id: number, suiteDelete?: SuiteDelete, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getSuites: (code: string, search?: string, limit?: number, offset?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
 ...
 * @export
 */
export declare const SuitesApiFp: (configuration?: Configuration) => {
    /**
     * This method is used to create a new test suite through API.
     * @summary Create a new test suite
     * @param {string} code Code of project, where to search entities.
     ...
     * @throws {RequiredError}
     */
    createSuite(code: string, suiteCreate: SuiteCreate, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IdResponse>>;
    /**
     * This method completely deletes a test suite with test cases from repository.
     * @summary Delete test suite
     * @param {string} code Code of project, where to search entities.
     ...
     * @throws {RequiredError}
     */
    deleteSuite(code: string, id: number, suiteDelete?: SuiteDelete, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IdResponse>>;
    /**
     * This method allows to retrieve a specific test suite.
     * @summary Get a specific test suite
     * @param {string} code Code of project, where to search entities.
     ...
     * @throws {RequiredError}
     */
    getSuite(code: string, id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SuiteResponse>>;
    /**
     * This method allows to retrieve all test suites stored in selected project.
     * @summary Get all test suites
     * @param {string} code Code of project, where to search entities.
     ...
     * @throws {RequiredError}
     */
    getSuites(code: string, search?: string, limit?: number, offset?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SuiteListResponse>>;
    /**
     * This method is used to update a test suite through API.
     * @summary Update test suite
     * @param {string} code Code of project, where to search entities.
     ...
     * @throws {RequiredError}
     */
    updateSuite(code: string, id: number, suiteUpdate: SuiteUpdate, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IdResponse>>;
};
/**
 * SuitesApi - factory interface
 * @export
 */
export declare const SuitesApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * This method is used to create a new test suite through API.
     * @summary Create a new test suite
     * @param {string} code Code of project, where to search entities.
...
export declare class SuitesApi extends BaseAPI {
     ...
     * @memberof SuitesApi
     */
    getSuites(code: string, search?: string, limit?: number, offset?: number, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<SuiteListResponse, any, {}>>;
    /**
     * This method is used to update a test suite through API.
     * @summary Update test suite
     * @param {string} code Code of project, where to search entities.
