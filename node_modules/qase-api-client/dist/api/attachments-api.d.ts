...
export declare const AttachmentsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getAttachments: (limit?: number, offset?: number, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    uploadAttachment: (code: string, file?: Array<any>, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const AttachmentsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    deleteAttachment(hash: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HashResponse>>;
    /**
     * This method allows to retrieve attachment by Hash.
     * @summary Get attachment by Hash
     * @param {string} hash Hash.
     ...
     * @throws {RequiredError}
     */
    getAttachment(hash: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AttachmentResponse>>;
    /**
     * This method allows to retrieve attachments.
     * @summary Get all attachments
     * @param {number} [limit] A number of entities in result set.
     ...
     * @throws {RequiredError}
     */
    getAttachments(limit?: number, offset?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AttachmentListResponse>>;
    /**
     * This method allows to upload attachment to Qase. Max upload size: * Up to 32 Mb per file * Up to 128 Mb per single request * Up to 20 files per single request  If there is no free space left in your team account, you will receive an error with code 507 - Insufficient Storage.
     * @summary Upload attachment
     * @param {string} code Code of project, where to search entities.
     ...
     * @throws {RequiredError}
     */
    uploadAttachment(code: string, file?: Array<File>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AttachmentUploadsResponse>>;
};
/**
